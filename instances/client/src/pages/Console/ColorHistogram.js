...
import {server_request, server_post_request, pathjoin} from 'utils/Utils'
...
export const updateHistogram = (stat_obj, window) => {
    ...
    let canvasid = "canvas_histogram_" + window
    let histostatsid = "histogramstats_histogram_" + window
...
function ColorHistogram(props) {
    ...
    const ID = props.id
    const canvasID = "canvas_" + ID // e.g. canvas_histogram_src
    const histogramstatsID = "histogramstats_" + ID
